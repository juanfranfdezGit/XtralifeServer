...
const db = mysql.createConnection({
    ...
    user: "frontier_esxtralifedb",
    password: "18111995",
    database: "frontier_esxtralifedb"
});
...
app.get('https://xtralife-server.onrender.com/', (req,res) => {
...
app.post('https://xtralife-server.onrender.com/signup', (req,res) => {
...
// registrados
app.post('https://xtralife-server.onrender.com/login', (req, res) => {
...
app.post('https://xtralife-server.onrender.com/delete', (req, res) => {
...
app.post('https://xtralife-server.onrender.com/edit', (req,res) => {
...
app.get('https://xtralife-server.onrender.com/userPage', (req, res) => {
